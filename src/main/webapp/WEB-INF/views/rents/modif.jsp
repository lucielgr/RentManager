        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <!-- form start -->
                        <form class="form-horizontal" method="post" action="/rentmanager/rents/modif?id=${id}">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="begin" name="begin" value="${debut_init}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="end" name="end" value="${fin_init}">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
